 ...
 */
const idElement1 = document.getElementById("title");
idElement1.textContent = "JSで変更した後のタイトル";
 ...
 */
const idElement2 = document.getElementById("description");
idElement2.innerHTML = "JSで変更した後の<strong>説明文</strong>";
 ...
 */
const idElement3 = document.getElementById("profile");
idElement3.setAttribute(
  "src",
 ...
 */
idElement1.className = "bg-yellow";
